...
let _viewGlobalsComponentRelativeFilename = null;
...
class BrowserViewFactory {
    ...
    static async clear() {
        ...
        _viewGlobalsComponentRelativeFilename = path.relative(_wrappedViewTmpDirname, path.resolve(__dirname, '../components')) + '/ViewGlobals.svelte';
...
import ViewGlobals from '${_viewGlobalsComponentRelativeFilename}';
