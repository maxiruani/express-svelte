...
function expressSvelte(opts = {}) {
    ...
    const _compileOptions = {
        ...
        dev,
        cache,
        hydrationMode: Utils.isValidHydrationMode(opts.hydrationMode) === true ? opts.hydrationMode : false,
    ...
    async function svelte(name, renderOptions = {}) {
        ...
        try {
            ...
            const hydrationMode = renderOptions.hydrationMode != null ? renderOptions.hydrationMode : _compileOptions.hydrationMode;
            ...
            if (hydratable === true) {
                ...
                scriptLegacy = bundlesHost + scriptsMap.get(`${filenameKey}-${scriptMode}l`) || null;
                scriptModern = bundlesHost + scriptsMap.get(`${filenameKey}-${scriptMode}m`) || null;
            }
